...
export const ThemeSwitch: React.FC<IProps> = (props: IProps): JSX.Element => {
    ...
    const [currentTheme, setCurrentTheme] = useState<ThemeType>(
        (theme as ThemeType) ?? "light"
    );

    useEffect(() => {
        const switchComponent =
            document.querySelector(".theme-switch").children[0];
        ...
        if (
            switchComponent &&
            currentTheme === "dark" &&
            !switchComponent.className.includes("checked")
        ) {
        ...
        <>
            <div className="theme-switch">
                <Switch
                    ...
                    checkedChildren={
                        <DarkModeIcon style={{ marginTop: "2px" }} />
                    }
                    unCheckedChildren={
                        <LightModeIcon style={{ marginTop: "2.3px" }} />
                    }
                />
            </div>
            <style jsx>
